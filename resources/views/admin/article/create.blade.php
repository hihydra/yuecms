                      ...
                      <div id="tab-1" class="tab-pane active">
                          <div class="panel-body">
                            ...
                            <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }}">
                              <label class="col-sm-1 control-label">{{trans('admin/article.model.category')}}</label>
                              <div class="col-sm-10">
                                <select data-placeholder="Choose a category..." class="selectpicker form-control" name="category_id">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                  ...
                                  <div>
                                    <span class="btn btn-default btn-file"><span class="fileinput-new">选择图片</span><span class="fileinput-exists">更换</span><input type="file" name="banner"></span>
